...
DROP FUNCTION [DBA_GD].CLIENTES_CUENTAS_INHAB
DROP FUNCTION [DBA_GD].CLIENTES_CON_COMISIONES
DROP FUNCTION [DBA_GD].CALCULAR_PROPIETARIO_CUENTA
DROP FUNCTION [DBA_GD].CLIENTES_CON_TRANSACCIONES_CTAS_PROPIAS
DROP FUNCTION [DBA_GD].PAISES_CON_MAS_MOVIMIENTOS
